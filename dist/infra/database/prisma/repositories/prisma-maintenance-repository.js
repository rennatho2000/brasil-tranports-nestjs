...
const prisma_maintenance_mapper_1 = require("../mappers/prisma-maintenance-mapper");
let PrismaMaintenanceRepository = class PrismaMaintenanceRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(maintenance) {
        const raw = prisma_maintenance_mapper_1.PrisMamaintenanceMapper.toPrisma(maintenance);
        await this.prisma.rawMaintenance.create({
            data: raw,
        });
    }
};
PrismaMaintenanceRepository = __decorate([
